...
async function getResponse(req: NextRequest): Promise<NextResponse> {
  ...
  if (buttonId === 1) {
    ...
    <meta property="fc:frame:image" content="${process.env.NEXT_PUBLIC_GATEWAY_URL}/ipfs/QmRp3YMQFLwdP1LZdsMfbMrBJqfhcXoKAb6ZYz5p38FHZV/1-1-1-1.jpeg?pinataGatewayToken=${process.env.NEXT_GATEWAY_KEY}" />
